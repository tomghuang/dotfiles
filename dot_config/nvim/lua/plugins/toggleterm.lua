return {
  {
    ...
    opts = {
      ...
      -- shell = "C:/Windows/System32/cmd.exe /s /k C:/Opt/clink/clink_x64.exe inject --profile C:/Users/tomgh",
      shell = "C:\\Windows\\System32\\cmd.exe /s /k C:\\Opt\\clink\\clink_x64.exe inject",
